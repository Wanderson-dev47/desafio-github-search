...
class MainActivity : AppCompatActivity() {
    ...
    private fun saveUserLocal(name: String) {
        ...
        with (sharedPref.edit()) {
            putString(getString(R.string.nome_usuario2), name)
            apply()
        }
    }
    ...
    private fun showUserName() {
        ...
        val name = sharedPref.getString(getString(R.string.nome_usuario2), "")
    ...
    fun getAllReposByUserName() {
        ...
        val sharedPref = getPreferences(Context.MODE_PRIVATE)
        val nome = sharedPref.getString(getString(R.string.nome_usuario2), "")
